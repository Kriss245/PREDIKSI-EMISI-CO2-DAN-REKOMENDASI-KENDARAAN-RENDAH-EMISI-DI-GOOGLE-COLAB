...
- **Library:** Pandas, Re, NumPy, Scikit-Learn, Seaborn, Matplotlib, IPyWidgets, dan IPython.Display.
...
2. **Simpan Salinan:** Pilih menu `File` > `Save a copy in Drive` agar Anda dapat mengedit dan menyimpan perubahan pada akun Google Anda sendiri.
3. **Unggah Dataset:**
